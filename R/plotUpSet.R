...
#'
#' This function creates an UpSet plot using the `ComplexHeatmap` package to visualize
#' intersections across multiple sets. Supports both `GenomicOverlapsResult` and `SetOverlapsResult` objects.
#'
