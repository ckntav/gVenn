...
#'   connecting lines. Can be a single color or a vector of colors (recycled to
#'   match the number of intersections). Default is "black".
#'
#' @return An UpSet plot object generated by \code{ComplexHeatmap::UpSet}. The
#'   right-hand annotation bars are labeled `"Region size"` for a
...
#'   `SetOverlapResult` input (no such transformation applies to gene/identifier
#'   sets).
#' @export
#'
#' @examples
