...
Genomic regions are first made non-overlapping, either merged into "reduced
regions" (`mode = "reduce"`, the default) or cut at every set boundary into
"disjoint regions" (`mode = "disjoin"`), and each region is then assigned to an
overlap group. Counts are therefore numbers of regions, not of input peaks.
